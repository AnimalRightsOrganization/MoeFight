...
namespace HotFix
{
    public class UI_Dialog : UIBase
    {
        ...
        [SerializeField] Button m_NoBtn;
        [SerializeField] Text m_NoBtnDesc;
        [SerializeField] Button m_YesBtn;
        [SerializeField] Text m_YesBtnDesc;
        ...
        public void Show(string message,
            Action action1 = null, string btnStr1 = "",
            Action action2 = null, string btnStr2 = "")
        {
            ...
            m_NoBtnDesc.text = string.IsNullOrEmpty(btnStr1) ? "" : btnStr1;
            if (action2 == null)
            {
                return;
            }
            ...
            m_YesBtnDesc.text = string.IsNullOrEmpty(btnStr2) ? "" : btnStr2;
        }
